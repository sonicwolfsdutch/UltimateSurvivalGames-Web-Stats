...
while($row = mysql_fetch_array($result)){
	...
	echo '<td><a href="index.php?page=player&player=',$row['lastname'],'"><img src=http://minecraft-skin-viewer.com/face.php?s=16&u=',$row['lastname'],'></a> <a href="index.php?page=player&player=',$row['lastname'],'">',$row['lastname'],'</a></td>';
